...
function GoogleButton() {
  return (
    ...
    >
      <div className="group mt-4 flex w-3/4 items-start justify-start rounded-xl border border-neutral-600 px-2 py-3 transition duration-300 transform-3d hover:scale-101 hover:shadow-lg hover:shadow-yellow-500/50">
